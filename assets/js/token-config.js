 ...
 * ============================================
 * Customize your pricing tiers and token quotas here.
 *
 * HOW TOKEN EXPIRY WORKS:
 * - Monthly plan: tokens reset every 30 days from purchase date
 * - Yearly plan: tokens reset every 365 days from purchase date
 *
 * HOW TO INTEGRATE REAL PAYMENTS:
 * - When a user completes payment via Stripe/PayPal, call:
 *   TokenSystem.activatePlan('pro', 'monthly')
 * - This saves the plan + token quota in localStorage
 */
